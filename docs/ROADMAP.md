...
- Claiming steganographic indistinguishability against a dedicated forensic
  adversary — the honest limits are documented in
  [docs/CRYPTO-REVIEW.md](CRYPTO-REVIEW.md).
